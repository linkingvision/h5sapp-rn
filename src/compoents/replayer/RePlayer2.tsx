...
const Player2=()=>{
	const videoThree =  useSelector((state: RootState) =>state.replay.videoThree)
	console.log(videoThree,['hhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhh']);
	...
	const url = 'ws://'+store.data.host+':'+store.data.port+'/api/v1/h5srtcapi?token='+videoThree+'&playback=true&profile=main&serverpb=true&begintime='+timevalues+'&endtime='+timevaluee+'&filename=fake&session='+store.data.session;
	console.log('====================================');
	console.log(url);
	console.log('====================================');
