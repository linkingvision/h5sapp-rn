...
const Player1=()=>{
	const videoTwo =  useSelector((state: RootState) =>state.replay.videoTwo)
	console.log(videoTwo,['hhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhh']);
	...
	const url = 'ws://'+store.data.host+':'+store.data.port+'/api/v1/h5srtcapi?token='+videoTwo+'&playback=true&profile=main&serverpb=true&begintime='+timevalues+'&endtime='+timevaluee+'&filename=fake&session='+store.data.session;
	console.log('====================================');
	console.log(url);
	console.log('====================================');
