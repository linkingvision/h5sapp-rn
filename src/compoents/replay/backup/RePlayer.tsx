...
const Player=()=>{
	...
	const url = 'ws://'+store.data.host+':'+store.data.port+'/api/v1/h5srtcapi?token='+videoOne+'&playback=true&profile=main&serverpb='+Adswitch+'&begintime='+timevalues+'&endtime='+timevaluee+'&filename=fake&session='+store.data.session;
